...
function PokemonVisual(props) {
    ...
    useEffect(() => {
        ...
        const url = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${props.pokemon.id}.png`;
        const img = new Image();
        ...
        setTimeout(() => setIsVisible(true), 50); // petite pause pour déclencher l'animation
        };

        const preloadImages = () => {
            const currentId = props.pokemon.id;
            const nextIds = [currentId - 1, currentId + 1, currentId + 2, currentId + 3];
                    ...
                    {currentSrc && (
                        <img
                            ...
                            style={{ display: isImageLoaded ? "block" : "none" ,
                                    ...
                                    transition: isVisible ? "all .2s ease-in-out" : "none"
                            }}
                            />)}
                </div>
